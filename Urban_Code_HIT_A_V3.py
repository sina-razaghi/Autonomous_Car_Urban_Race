...
import function_V2 as function_V3
...
while(True):  
    ...
    # side_mask = cv2.inRange(frame, np.array([120,100,120]), np.array([140,150,161])) * (1-car_mask)
    ...
    sign = function_V3.detect_sign(image[100:400, 280:512])
