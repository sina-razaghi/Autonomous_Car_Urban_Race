...
while(True):  
    ...
    if horiz_detected:
        ...
        if not red_sign:
            if sign_state == 'nothing':
                ...
                if side_pix > 128:
                    utils.turn_the_car(car,0,4)
                    utils.turn_the_car(car,100,6)
                else:
    ...
    # showing some info
    cv2.putText(frame, "horiz_line", (96,150), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), 2)
    frame = cv2.rectangle(frame,(96,160),(160,180),(0,255,0),1)
    cv2.putText(frame, "side_line", (0,150), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 255), 2)
