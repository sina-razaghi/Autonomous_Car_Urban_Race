...
while(True):  
    ...
    sign = function_V3.detect_sign(frame)
    if sign == 'left':
        sign_state = 'left'
    elif sign == 'straight':
        sign_state = 'straight'
    ...
    cv2.putText(debugFrame, "side_line", (0,140), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 255), 2)
    debugFrame = cv2.rectangle(debugFrame,(0,150),(256,190),(0,255,255),1)
    ...
    result = np.concatenate([np.concatenate([debugFrame,cv2.cvtColor(function_V3.region_of_interest(white_mask)*255, cv2.COLOR_GRAY2BGR)], 0),
